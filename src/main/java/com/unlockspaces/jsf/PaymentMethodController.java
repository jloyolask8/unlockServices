...
import com.unlockspaces.ejb.PaymentMethodFacade;
...
public class PaymentMethodController implements Serializable {
    ...
    @EJB
    private com.unlockspaces.ejb.PaymentMethodFacade ejbFacade;
    ...
    public String prepareView() {
        current = (PaymentMethod) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentMethodCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentMethodUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentMethodDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public PaymentMethod getPaymentMethod(java.lang.String id) {
    ...
    public static class PaymentMethodControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PaymentMethod) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PaymentMethod.class.getName());
            }
        }
