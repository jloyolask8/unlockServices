...
public class SpaceController implements Serializable {
    ...
    @EJB
    private com.unlockspaces.ejb.SpaceFacade ejbFacade;
...
//            webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{current.getId()})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON).put(javax.ws.rs.client.Entity.entity(current, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SpaceDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Space getSpace(java.lang.Long id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Space.class)
    public static class SpaceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SpaceController controller = (SpaceController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "spaceController");
            return controller.getSpace(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Space) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Space.class.getName());
            }
        }
